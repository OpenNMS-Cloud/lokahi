...
import org.opennms.horizon.config.conf.xml.EventOrdering.EventOrderIndex;
...
public class Event implements Serializable, Comparable<Event> {
    ...
    public MatchResult matches(final org.opennms.horizon.config.xml.Event matchingEvent) {
        if (m_matcher == null) {
