...
public class InventoryClient {
    ...
    public List<MonitoringSystemDTO> listMonitoringSystemsByLabel(String label, String accessToken) {
        Metadata metadata = new Metadata();
        metadata.put(GrpcConstants.AUTHORIZATION_METADATA_KEY, accessToken);
        return systemStub.withInterceptors(MetadataUtils.newAttachHeadersInterceptor(metadata)).withDeadlineAfter(deadline, TimeUnit.MILLISECONDS).listMonitoringSystemByLabel(StringValue.of(label)).getSystemsList();
    }
