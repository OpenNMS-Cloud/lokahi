...
package org.opennms.horizon.config;

import org.opennms.horizon.config.conf.xml.EnterpriseIdPartition;
import org.opennms.horizon.config.util.JaxbUtils;
import org.opennms.horizon.config.api.EventConfDao;
import org.opennms.horizon.config.conf.xml.Event;
import org.opennms.horizon.config.conf.xml.EventOrdering;
import org.opennms.horizon.config.conf.xml.Events;
import org.opennms.horizon.config.conf.xml.Partition;
...
public class DefaultEventConfDao implements EventConfDao {
    ...
    @Override
    public Event findByEvent(org.opennms.horizon.config.xml.Event matchingEvent) {
