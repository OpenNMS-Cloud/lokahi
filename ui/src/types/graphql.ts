...
export const DownloadAlertsByNodeDocument = {'kind': 'Document', 'definitions': [{'kind': 'OperationDefinition', 'operation': 'query', 'name': {'kind': 'Name', 'value': 'downloadRecentAlertsByNode'}, 'variableDefinitions': [{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'nodeId' } }, 'type': { 'kind': 'NonNullType', 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Long' } } } }, {'kind': 'VariableDefinition', 'variable': {'kind': 'Variable', 'name': {'kind': 'Name', 'value': 'page'}}, 'type': {'kind': 'NonNullType', 'type': {'kind': 'NamedType', 'name': {'kind': 'Name', 'value': 'Int'}}}}, {'kind': 'VariableDefinition', 'variable': {'kind': 'Variable', 'name': {'kind': 'Name', 'value': 'pageSize'}}, 'type': {'kind': 'NonNullType', 'type': {'kind': 'NamedType', 'name': {'kind': 'Name', 'value': 'Int'}}}}, {
  kind: 'VariableDefinition',
  variable: { kind: 'Variable', name: { kind: 'Name', value: 'sortBy' } },
  type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
}, {
  kind: 'VariableDefinition',
  variable: { kind: 'Variable', name: { kind: 'Name', value: 'downloadFormat' } },
  type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'DownloadFormat' } } }
},
{'kind': 'VariableDefinition', 'variable': {'kind': 'Variable', 'name': {'kind': 'Name', 'value': 'sortAscending'}}, 'type': {'kind': 'NonNullType', 'type': {'kind': 'NamedType', 'name': {'kind': 'Name', 'value': 'Boolean'}}}}],
