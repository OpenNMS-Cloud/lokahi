...
import listener.syslog.Rfc5424SyslogParser;
...
public class Rfc5424SyslogParserTest {
    ...
    private void checkDateParserWith(TimeZone expectedTimeZone, String timezoneProperty) throws IOException {
        ...
        final Rfc5424SyslogParser parser = new Rfc5424SyslogParser(config, SyslogdTestUtils.toByteBuffer("something"));
    ...
    private void checkDateParserWith(TimeZone expectedTimeZone, String pattern, Rfc5424SyslogParser parser) throws IOException {
