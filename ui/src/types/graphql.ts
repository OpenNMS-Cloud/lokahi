...
export type AlertsByNodeListVariables = Exact<{
  page: Scalars['Int'];
  pageSize?: InputMaybe<Scalars['Int']>;
...
export const AlertsByNode = { 'kind': 'Document', 'definitions': [{ 'kind': 'OperationDefinition', 'operation': 'query', 'name': { 'kind': 'Name', 'value': 'AlertsPartsList' }, 'variableDefinitions': [{ 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'page' } }, 'type': { 'kind': 'NonNullType', 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Int' } } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'pageSize' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Int' } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortAscending' } }, 'type': { 'kind': 'NonNullType', 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'Boolean' } } } }, { 'kind': 'VariableDefinition', 'variable': { 'kind': 'Variable', 'name': { 'kind': 'Name', 'value': 'sortBy' } }, 'type': { 'kind': 'NamedType', 'name': { 'kind': 'Name', 'value': 'String' } } }, { kind: 'VariableDefinition', variable: { kind: 'Variable', name: { kind: 'Name', value: 'nodeId' } }, type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'Long' } } } }], 'selectionSet': { 'kind': 'SelectionSet', 'selections': [{ 'kind': 'FragmentSpread', 'name': { 'kind': 'Name', 'value': 'AlertsPartsList' } }] } }, ...AlertsPartsByNode.definitions] } as unknown as DocumentNode<AlertsByNodeListQuery, AlertsByNodeListVariables>
