...
public class ConfigurationService {
    ...
    public Configuration createSingle(ConfigurationDTO newConfigurationDTO) {
        ...
        List<Configuration> configurations = modelRepo.findByTenantIdAndKeyAndLocation(
        ...
        Configuration configuration = mapper.dtoToModel(newConfigurationDTO);
        return modelRepo.save(configuration);
    }
    ...
    public List<ConfigurationDTO> findByKey(String key) {
        List<Configuration> all = modelRepo.findByTenantId(key);
        return all
            .stream()
            .map(mapper::modelToDTO)
            .collect(Collectors.toList());
    ...
    public List<ConfigurationDTO> findByLocation(String location) {
        List<Configuration> all = modelRepo.findByTenantId(location);
        return all
            .stream()
            .map(mapper::modelToDTO)
            .collect(Collectors.toList());
    ...
    public List<ConfigurationDTO> findByTenantIdAndKeyAndLocation(String tenantId, String key, String location) {
        List<Configuration> all = modelRepo.findByTenantIdAndKeyAndLocation(tenantId, key, location);
        return all
            .stream()
            .map(mapper::modelToDTO)
            .collect(Collectors.toList());
    ...
    public List<ConfigurationDTO> findByKeyAndLocation(String key, String location) {
        List<Configuration> all = modelRepo.findByKeyAndLocation(key, location);
        return all
            .stream()
            .map(mapper::modelToDTO)
            .collect(Collectors.toList());
