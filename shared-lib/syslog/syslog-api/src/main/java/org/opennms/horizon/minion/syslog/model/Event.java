...
import org.opennms.horizon.minion.syslog.InetAddressUtils;

import org.opennms.horizon.minion.syslog.xml.event.*;
...
public class Event implements Message,Serializable {
	...
	public String getInterface() {
		if (_interfaceString == null) {
			_interfaceString = InetAddressUtils.str(_interfaceAddress);
		}
	...
	public void setInterface(final String _interface) {
		_interfaceAddress = InetAddressUtils.addr(_interface);
