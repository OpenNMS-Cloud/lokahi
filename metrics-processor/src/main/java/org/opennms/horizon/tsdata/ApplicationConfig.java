...
public class ApplicationConfig {
    ...
    @Value("${cortex.read.url}")
    private String cortexReadURL;
    ...
    @Value("${cortex.metriccachesize:1000}")
    private long metricCacheSize;
    @Value("${cortex.externaltagscachesize:1000}")
    ...
    public CortexTSSConfig cortexTSSConfig() {
        return new CortexTSSConfig(cortexWriteURL, cortexReadURL, maxConcurrentHttpConnections, cortexWriteTimeoutInMs, readTimeoutInMs, metricCacheSize, externalTagsCacheSize, bulkheadMaxWaitDurationInMs, organizationId);
    }
    @Bean
