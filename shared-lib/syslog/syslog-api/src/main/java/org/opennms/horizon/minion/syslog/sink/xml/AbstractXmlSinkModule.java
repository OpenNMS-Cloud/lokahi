 ...
 * License.
 */
package org.opennms.horizon.minion.syslog.sink.xml;


import org.opennms.horizon.minion.syslog.AggregationPolicy;
import org.opennms.horizon.minion.syslog.AsyncPolicy;
import org.opennms.horizon.minion.syslog.Message;
import org.opennms.horizon.minion.syslog.SinkModule;
...
public abstract class AbstractXmlSinkModule<S extends Message, T extends Message> implements SinkModule<S, T> {
    ...
    public abstract AggregationPolicy<S, T, ?> getAggregationPolicy();
