 ...
 * License.
 */
package org.opennms.horizon.minion.syslog.config;

import org.opennms.horizon.minion.syslog.api.ConfigReloadContainer;
import org.opennms.horizon.minion.syslog.utils.ConfigFileConstants;
import org.opennms.horizon.minion.syslog.utils.JaxbUtils;
import org.opennms.horizon.minion.syslog.syslogd.HideMatch;
import org.opennms.horizon.minion.syslog.syslogd.SyslogdConfiguration;
import org.opennms.horizon.minion.syslog.syslogd.SyslogdConfigurationGroup;
import org.opennms.horizon.minion.syslog.syslogd.UeiMatch;
...
public final class SyslogdConfigFactory implements SyslogdConfig {
    ...
    /**
     * Private constructorn
     *
     * @throws IOException Thrown if the specified config file cannot be read
     */
     ...
     *
     * @throws IOException Thrown if the specified config file cannot be
     *                             read/loaded
     */
